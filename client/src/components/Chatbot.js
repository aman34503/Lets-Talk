...
const steps = [
    ...
    },
    {
        id: "sad",
        message:
            "I am sorry to here that 😟 . Well i would suggest to do some Yoga. You will feel better.🙂",
        trigger: "help",
    },
    {
        id: "angry",
    ...
    },
    {
        ...
        options: [
            ...
            { value: "emotional", label: "emotional", trigger: "selectedService" },
            {
                value: "Dance",
                label: "dance",
    ...
    const handleEnd = ({ steps, values }) => {
        switch (values[values.length - 1]) {
            case "Home":
                ...
                break;
            case "emotional":
                history.push("/emotional");
                break;
            case "mindfullness":
                history.push("/minfullness");
                break;
            default:
                break;
        }
